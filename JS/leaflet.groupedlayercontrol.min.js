L.Control.GroupedLayers = L.Control.extend({
    ...
    onAdd: function (a) {
        return this._initLayout(),
            this._update(),
            a.on("layeradd", this._onLayerChange, this)
                .on("layerremove", this._onLayerChange, this),
            this._container
    },

    onRemove: function (a) {
        a.off("layeradd", this._onLayerChange)
    ...
    removeLayer: function (a) {
        var b = L.Util.stamp(a),
            c = this._getLayer(b);
        return c && delete this.layers[this.layers.indexOf(c)],
            this._update(),
            this
    },
    ...
    _addLayer: function (a, b, c, d) {
        ...
        var f = this._indexOf(this._groupList, c); -1 === f && (f = this._groupList.push(c) - 1); var g = -1 !== this._indexOf(this.options.exclusiveGroups, c); e.group = { name: c, id: f, exclusive: g }, this.options.autoZIndex && a.setZIndex && (this._lastZIndex++, a.setZIndex(this._lastZIndex))
    },
    ...
    _update: function () {
        if (this._container) {
            ...
            for (var a, b, c = !1, d = !1, a = 0; a < this._layers.length; a++)
                b = this._layers[a], this._addItem(b),
                    d = d || b.overlay, c = c || !b.overlay;
    ...
    _onLayerChange: function (a) {
        ...
        c && (this._handlingClick || this._update(),
            b = c.overlay ? "layeradd" === a.type ? "overlayadd" : "overlayremove" : "layeradd" === a.type ? "baselayerchange" : null, b && this._map.fire(b, c))
    },

    _createRadioElement: function (a, b) {
        var c = '<input type="radio" class="leaflet-control-layers-selector" name="' + a + '"'; b && (c += ' checked="checked"'), c += "/>";
    ...
    _onGroupInputClick: function () {
        ...
        for (a = 0; f > a; a++)b = e[a],
            b.groupID === this.groupID && "leaflet-control-layers-selector" === b.className && (b.checked = this.checked,
                c = d._getLayer(b.layerId), b.checked && !d._map.hasLayer(c.layer) ? d._map.addLayer(c.layer) : !b.checked && d._map.hasLayer(c.layer) && d._map.removeLayer(c.layer));
        d._handlingClick = !1
    },
    ...
    _expand: function () {
        ...
        a < this._form.clientHeight && (L.DomUtil.addClass(this._form, "leaflet-control-layers-scrollbar"),
