...
L.Control.PanelLayers = L.Control.Layers.extend({
	...
	_createItem: function (obj) {
		...
		// var legend_ul = L.DomUtil.create('ul', this.className + '-ul');
		// var legend_li = L.DomUtil.create('li');
		// var legend_img = L.DomUtil.create('img');
		// var legend_span = L.DomUtil.create('span');

		label.innerHTML = obj.name || '';
		// legend_span.innerHTML = obj.name || '';
		// legend_img.setAttribute("src", "data:image/png;base64,");
		...
		// label.appendChild(legend_ul);
		// legend_ul.appendChild(legend_li);
		// legend_li.appendChild(legend_img);
		// legend_li.appendChild(legend_span);
